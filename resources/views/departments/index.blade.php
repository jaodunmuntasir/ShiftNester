...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('departments.create') }}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
            Add New Department
        </a>
    </div>
            ...
            <tbody>
                @foreach ($departments as $department)
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <a href="{{ route('departments.edit', $department) }}" class="text-blue-600 hover:text-blue-900 mr-2">Edit</a>
