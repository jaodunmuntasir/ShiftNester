        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden mt-6 p-6">
            <form action="{{ route('departments.update', $department) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" value="{{ $department->name }}" class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                </div>
